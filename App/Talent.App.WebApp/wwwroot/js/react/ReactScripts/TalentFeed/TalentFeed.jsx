...
export default class TalentFeed extends React.Component {
    ...
    getTalentSnapshotList(position, number) {
        ...
        $.ajax({
            ...
            url: `https://talentservicesprofile20210915205804.azurewebsites.net/profile/profile/getTalent?position=${position}&number=${number}`,
            headers: {
            ...
            success: function (res) {
                if (res.success) {
                    ...
                    console.log("--> getTalentSnapshotListError - FE")
                }
            }.bind(this),
            error: function (res) {
    ...
    getCompanyData() {
        ...
        $.ajax({
            ...
            url: 'https://talentservicesprofile20210915205804.azurewebsites.net/profile/profile/getEmployerProfile',
            headers: {
